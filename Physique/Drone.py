...
class Drone:
    ...
    def __init__(self, world):
        ...
        self.aileD = S.Aile(E.Vecteur(PM.ailesD_x_BA,PM.ailesD_z_BA,self.structure),PolaireTabulee("./XFLR5/CLwing","./XFLR5/CDwing","./XFLR5/CMwingBA"), PM.aileD_S, PM.ailesD_corde, PM.flapsDPourcentageCordeArticulee,PM.flapsDPourcentageEnvergureArticulee, PM.flapsDMaxAngle, PM.aileD_Calage, world, father = self.structure)
        self.aileG = S.Aile(E.Vecteur(PM.ailesG_x_BA,PM.ailesG_z_BA,self.structure),PolaireTabulee("./XFLR5/CLwing","./XFLR5/CDwing","./XFLR5/CMwingBA"), PM.aileG_S, PM.ailesG_corde, PM.flapsGPourcentageCordeArticulee,PM.flapsGPourcentageEnvergureArticulee, PM.flapsGMaxAngle, PM.aileG_Calage, world, father = self.structure)
        self.empennageD = S.Empennage(E.Vecteur(PM.empennageD_x_BA,PM.empennageD_z_BA, self.structure),PolaireTabulee("./XFLR5/CLtail","./XFLR5/CDtail","./XFLR5/CMtailBA"),PM.empennageD_S,PM.empennageD_corde,PM.elevDPourcentageCordeArticulee,PM.elevDPourcentageEnvergureArticulee,PM.elevDMaxAngle, PM.angleDemiDiedreEmpennageD, PM.empennageD_Calage, world,father= self.structure)
        self.empennageG = S.Empennage(E.Vecteur(PM.empennageG_x_BA,PM.empennageG_z_BA, self.structure),PolaireTabulee("./XFLR5/CLtail","./XFLR5/CDtail","./XFLR5/CMtailBA"),PM.empennageG_S,PM.empennageG_corde,PM.elevGPourcentageCordeArticulee,PM.elevGPourcentageEnvergureArticulee,PM.elevGMaxAngle, PM.angleDemiDiedreEmpennageG, PM.empennageD_Calage, world,father= self.structure)
