...
class Drone:
    ...
    def __init__(self, world):
        ...
        self.empennageD = S.Empennage(E.Vecteur(PM.empennageD_x_BA,PM.empennageD_z_BA, self.structure),PolaireTabulee("./XFLR5/CLtail","./XFLR5/CDtail","./XFLR5/CMtailBA"),PM.empennageD_S,PM.empennageD_corde,PM.elevDPourcentageCordeArticulee,PM.elevDPourcentageEnvergureArticulee,PM.elevDMaxAngle, world,father= self.structure)
        self.empennageG = S.Empennage(E.Vecteur(PM.empennageG_x_BA,PM.empennageG_z_BA, self.structure),PolaireTabulee("./XFLR5/CLtail","./XFLR5/CDtail","./XFLR5/CMtailBA"),PM.empennageG_S,PM.empennageG_corde,PM.elevGPourcentageCordeArticulee,PM.elevGPourcentageEnvergureArticulee,PM.elevGMaxAngle, world,father= self.structure)
