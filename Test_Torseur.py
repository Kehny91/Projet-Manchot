...
refAero = E.Referentiel("refAero",np.pi/3,E.Point(4,6))
refTerrestre = E.Referentiel("refTerrestre",0,E.Point(0,0))
...
print("\n")
print("__comoment__")
print("torseur1 com torseur1 = Vecteur(17,17,refterrestre)")
print (torseur1.comoment(torseur1))
print(torseur1.comoment(torseur2))
print(torseur2.comoment(torseur1))