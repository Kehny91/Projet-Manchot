...
class ParametresModele:
    ...
    flapsDPourcentage   = 0.1           #%, pourcentage d influence du flap sur l incidence de l aile
    ...
    flapsGPourcentage   = 0.1           #%, pourcentage d influence du flap sur l incidence de l aile
    ...
    elevDMaxAnglePourcentage = 0.1      #%, pourcentage d'influence de la gouverne sur l incidence de l empennage
    ...
    elevGMaxAnglePourcentage = 0.1      #%, pourcentage d'influence de la gouverne sur l incidence de l empennage
