...
print("translation du vecteur1 dans le refAero = vecteur(9,20,refAero)? ")
print(vecteur1.translationRef(refAero))
print(vecteur1.translationRef(refAero).translationRef(refTerrestre))
print("\n")
print("__changeRef__")
print("Le vecteur1 dans le refAero = vecteur(1,-8,refAero)? ")
